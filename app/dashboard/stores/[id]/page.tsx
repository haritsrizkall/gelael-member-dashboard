      ...
      <div className="p-6.5">
        <div className="mb-4.5 flex w-full">
          ...
          <div className="grow">
            <div>
              ...
              <div className="mb-4.5">
                <label className="mb-2.5 block text-black dark:text-white">
                  Store Manager Image (Kosongkan jika tidak ingin update image - jpg, jpeg, png)
                </label>
                <input
                  disabled={!editModeManager}
                  required
        ...
        <div className="mb-4.5 flex w-full">
          ...
          <div className="grow">
            <div className="mb-4.5">
              ...
              <div className="mb-4.5">
                <label className="mb-2.5 block text-black dark:text-white">
                  Duty Manager Image (Kosongkan jika tidak ingin update image - jpg, jpeg, png)
                </label>
                <input
                  disabled={!editModeManager}
                  required
        ...
        <div className="mb-4.5 flex">
          ...
          <div className="grow">
            ...
            <div className="mb-4.5">
              <label className="mb-2.5 block text-black dark:text-white">
                Duty Manager 2 Image (Kosongkan jika tidak ingin update image - jpg, jpeg, png)
              </label>
              <input
                disabled={!editModeManager}
                required
